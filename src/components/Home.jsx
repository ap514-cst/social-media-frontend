...
const Home = () => {
  ...
  useEffect(() => {
    fetch("https://social-media-backend-4-67g5.onrender.com/api/products/get")
      .then((res) => res.json())
      .then((data) => {
  ...
  const likePost = (id) => {
    playLikeSound()
    fetch("https://social-media-backend-4-67g5.onrender.com/api/user/likes", {
      method: "PUT",
      headers: {
  ...
  const DislikePost = (id) => {
    fetch("https://social-media-backend-4-67g5.onrender.com/api/user/dislikes", {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("token")
  ...
  const addComment = () => {
    ...
    try {
      fetch("https://social-media-backend-4-67g5.onrender.com/api/user/comment", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + localStorage.getItem("token")
  ...
  const deletedComment = (postId, commentId) => {
    try {
      fetch("https://social-media-backend-4-67g5.onrender.com/api/user/deletecomment", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + localStorage.getItem("token")
